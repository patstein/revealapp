...
def trainSuggest():
    ...
    #receive json and convert appropriately:    
    posted_tags_and_suggTags = request.get_json(force = True)    
    ...
    posted_tags = posted_tags_and_suggTags["tags"]
    posted_suggTags = posted_tags_and_suggTags["suggTags"]    

    Suggested_tags_json = dummy_model.trainSuggest(posted_tags, posted_suggTags)
