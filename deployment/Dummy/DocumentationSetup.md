inspired from here: https://github.com/polyledger/connect/wiki/Deployment:-Docker-Compose-on-DigitalOcean-Droplet
...
## Step 2: Configure Ubuntu - DONE

SSH into the droplet:

```
ssh root@134.209.231.8
```

You will be asked to update the root password. (SK: There is none)
...
Set Firewall (ufw) settings right
```
$ ufw default allow
$ ufw enable
$ sudo ufw allow 22/tcp #The standard TCP port for SSH is 22
$ ufw default deny
$ ufw allow 8889 #allow the port from our API
$ ufw status verbose
```
...
| 8889                 |      ALLOW IN  |  Anywhere      |           
| 22/tcp (v6)          |      ALLOW IN  |  Anywhere (v6) |           
| 8889 (v6)            |      ALLOW IN  |  Anywhere (v6) |



## Step 3: Clone the application - Ends here - DONE

Clone the GitHub repository in the home folder:

```
cd /home && git clone https://gitlab.propulsion-home.ch/datascience/projects/final-projects/ds-2020-02/revealapp.git
```

You will be prompted for a GitLab username and password.



## requests for API on digital ocean
```
ssh root@134.209.231.8
cd /home/revealapp/50_deployment/
